...
async function sendMessage(links,page){
    for(let i=0;i<links.length;i++){
        ...
        let msg = `Hi ${name} ! 
My name is Naman Aggarwal, a fourth year student pursuing B.tech from GGSIPU(2022 passout year) and currenty looking for SDE roles , My key skills are - Strong Problem Solving, Java, OOPs, HTML,CSS, JavaScript,React, SQL and NoSQL.
I have solved 500+ questions on various platforms combined.
